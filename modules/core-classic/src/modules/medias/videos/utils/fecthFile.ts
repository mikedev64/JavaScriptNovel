 ...
 */
export async function fecthFiles(type: CoreGenerics.TFileTypeVideo, path: CoreGenerics.TFilePath): TFecthFiles {
        const validFormats: CoreGenerics.TFileTypeVideo[] = ["mp4", "webm", "avi"];
        ...
        // Determinar la ruta base para videos
        const basePath = LocationFiles.videos.development;
